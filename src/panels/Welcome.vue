<template>
  <div>
    <el-row>
      <el-col>
        <div class="welcome-text">
          ...
          <br />
          <br />If you're a server owner you'll find options on any servers containing the ⭐️ listed under the owners category of the dropdown.
          <br />
          <br />Every user will see all other available Bot options in the left menu after selecting a server.
        </div>
      </el-col>
    </el-row>
    ...
    <el-row class="statistics">
      <BotStatistic :text="'Completed Commands'" :value="bot.stats.commands.completed" :backgroundColor="'#05b770'" :fontColor="'#fff'" />
      <BotStatistic
        :text="'Total Commands'"
      ...
      />
      <BotStatistic :text="'Invalid Commands'" :value="bot.stats.commands.invalid" :backgroundColor="'#c0392b'" :fontColor="'#fff'" />
...
export default class WelcomePanel extends Vue {
  ...
  private calculateSuccessPerc() {
    return (this.bot.stats.commands.completed / (this.bot.stats.commands.completed + this.bot.stats.commands.invalid)) * 100
  }

  private calculateFailedPerc() {
    return (this.bot.stats.commands.invalid / (this.bot.stats.commands.completed + this.bot.stats.commands.invalid)) * 100
  }
}
</script>
